...
const SignInForm = () => {
  ...
  return (
    <div className="flex justify-center items-center w-full h-screen">
      <div className="w-[361px] mx-auto p-2 my-8 bg-white rounded-lg  text-center relative">
        <h2 className="text-2xl font-medium mb-2">SIGN IN</h2>
        <p className="text-[#222222] text-base font-normal mb-10">
        ...
        <form onSubmit={handleSubmit}>
              ...
              <div className="mb-6 border-[1px] border-[#C2C2C2] rounded-lg h-14 relative flex items-center">
                ...
                <div className="flex items-center">
                  ...
                  <button
                    ...
                    className="ml-2 px-4 py-2  text-[#161EDD] text-[12px] font-medium rounded text-nowrap"
                  >
                    Get OTP
                  </button>
                </div>
                  ...
                  {otp.map((value, index) => (
                    <div key={index} className="relative">
                      <input
                        ...
                        type="text"
                        maxLength="1"
                        className="w-8  text-center text-[12px] font-medium text-[#000000] border-b-[1px] border-[#C2C2C2] focus:outline-none"
                        value={value}
          ...
          <div className="mt-6 text-[10px] text-center font-normal">
